    ...
    pricing: [
      ...
      },
      {
        ...
        features: [
          ...
          { en: "Staff Attendance Web App with Real-time & Location Tracking + Reporting", bm: "Aplikasi Web Kehadiran Kakitangan dengan Penjejakan Masa Nyata & Lokasi + Laporan", zh: "带实时和位置跟踪+报告的员工考勤网络应用", starred: true },
          { en: "Monthly 2 Meetings", bm: "2 Mesyuarat Bulanan", zh: "每月2次会议" },
        ],
      },
      {
        ...
        features: [
          ...
          { en: "Staff Attendance Web App with Real-time & Location Tracking + Reporting", bm: "Aplikasi Web Kehadiran Kakitangan dengan Penjejakan Masa Nyata & Lokasi + Laporan", zh: "带实时和位置跟踪+报告的员工考勤网络应用", starred: true },
          { en: "Custom App or Web Development & Maintenance", bm: "Pembangunan & Penyelenggaraan Aplikasi atau Web Tersuai", zh: "定制应用或网站开发与维护", starred: true },
          { en: "Monthly 2 Meetings", bm: "2 Mesyuarat Bulanan", zh: "每月2次会议" },
        ],
      },
    ],
